...
% Sort the given list of numbers a according to how far away each element 
% is from the target value t. The result should return the list sorted in 
